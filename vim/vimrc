...
augroup line_wrapper
    autocmd!
    autocmd FileType tex,text set wrap
    autocmd FileType tex,text nnoremap j gj
    autocmd FileType tex,text nnoremap k gk
    autocmd FileType tex,text vnoremap j gj
    autocmd FileType tex,text vnoremap k gk
